...
public class LcarsApp extends Application {
	...
	public static final Color LAVENDER = Color.web("#D3D3FF");
	public static final Color SALMON = Color.web("#FF8C78");
	public static final Color AMBER  = Color.web("#FFCC66");
	public static final Color ORANGE = Color.web("#f89d00");
	public static final Color BLUE   = Color.web("#6699FF");
	public static final Color RED = Color.web("#cd666c");
		...
		//adds the on click sound
		 ...
		 scene.setOnMousePressed(event -> {
	            switch (event.getButton()) {
	                case PRIMARY -> click.play(); // left mouse button
	...
	private Parent buildMainConsole(Stage owner) {
		...
		root.setTop(new VBox(bars, spacer(8)));
		...
		r3.setMinHeight(23);
		r3.setPrefHeight(23);
		r3.setBackground(new Background(new BackgroundFill(LAVENDER, null, null)));
		desktopCard.setPrefHeight(5000);
		centerbody.getChildren().addAll(r3,desktopCard);
	...
	private VBox buildLeftButtonBars() {
		// TODO Auto-generated method stub
		VBox leftBarButtons = new VBox(5);
		...
		Rectangle topButton = new Rectangle(200, 200); // width x height
		topButton.setArcWidth(6); // rounded corners LCARS-style
		topButton.setArcHeight(6);
		topButton.setFill(PEACH);

		Rectangle topMiddleButton = new Rectangle(200, 200); // width x height
		topMiddleButton.setArcWidth(6); // rounded corners LCARS-style
		topMiddleButton.setArcHeight(6);
		topMiddleButton.setFill(AMBER);

		Rectangle bottomMiddleButton = new Rectangle(200, 200); // width x height
		bottomMiddleButton.setArcWidth(6); // rounded corners LCARS-style
		bottomMiddleButton.setArcHeight(6);
		bottomMiddleButton.setFill(ORANGE);

		Rectangle bottomButton = new Rectangle(200, 200); // width x height
		bottomButton.setArcWidth(6); // rounded corners LCARS-style
		bottomButton.setArcHeight(6);
		bottomButton.setFill(RED);

		// Optional: make it clickable
		topButton.setOnMouseClicked(e -> {
		    System.out.println("Rectangle button clicked!");
		});
		topMiddleButton.setOnMouseClicked(e -> {
		    System.out.println("Rectangle button clicked!");
		});
		bottomMiddleButton.setOnMouseClicked(e -> {
		    System.out.println("Rectangle button clicked!");
		});
		...
		leftBarButtons.getChildren().addAll(curve, topButton, topMiddleButton, bottomMiddleButton, bottomButton);

		return new VBox(6,leftBarButtons);
	}
	...
	private ExplorerView buildExplorerView(File startDir, Runnable onClose) {
		...
		VBox header = new VBox(spacer(6), toolbar, spacer(4), quick);
